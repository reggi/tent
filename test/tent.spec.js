...
assert.deepEqual(parseComments(['tent my-build@1.0.0']), [{"build": "my-build@1.0.0"}])
assert.deepEqual(parseComments(['tent build my-build@1.0.0']), [{'build': 'my-build@1.0.0'}])
assert.deepEqual(parseComments(['tent from my-foundation@1.0.0']), [{'foundation': 'my-foundation@1.0.0'}])
assert.deepEqual(parseComments(['tent foundation my-foundation@1.0.0']), [{'foundation': 'my-foundation@1.0.0'}])
assert.deepEqual(parseComments(['tent my-build@1.0.0 my-foundation@1.0.0']), [{"build": "my-build@1.0.0", 'foundation': 'my-foundation@1.0.0'}])
